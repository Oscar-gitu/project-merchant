...
DB_CONFIG = get_parameter(f"/config/infra/{ENVIRONMENT}/db/credentials", default={})
...
DB_PASSWORD = DB_PASSWORD or json.loads(get_secret(DB_CONFIG.get("db-password")))["password"]
